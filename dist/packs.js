...
export async function addPack(options = {}, source) {
...
async function planInstall(packRoot, targetPath, prefix) {
    if (prefix) {
        return [{
                from: packRoot,
    ...
    if (hasRootScript) {
        throw new CliError("PACK_INVALID", "Pack defines a command at its .cli/ root. Install it under a name with --prefix <name>.");
    }
    return entries
...
async function gitClone(source, destination) {
